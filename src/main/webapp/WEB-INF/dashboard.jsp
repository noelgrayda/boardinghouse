...
<body>
	<div class="bg-img d-flex align-items-center justify-content-center" style="background-image: url('img/children-g38dda8e37_1920.jpg');
		...
		<div class="container-md border bg-white">
			...
			<form action="/rooms" class="d-grid gap-2 m-2">
				<input type="submit" value="Check rooms"/>
			</form>
			<form action="/boarders" class="d-grid gap-2 m-2">
				<input type="submit" value="Check boarders"/>
			</form>
